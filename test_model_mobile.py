...
def test_model(input_image_path, output_image_path, model_weights_path, yolov5_weights_path, class_names_path):
    ...
    model = MobileNetV3SmallUNet(num_classes=3).to(device)
...
if __name__ == '__main__':
    # Define paths
    input_image_path = 'test_img/3.bmp'  # Path to your test image
    output_image_path = 'results/enhanced_image.jpg'  # Path to save the enhanced image
    model_weights_path = 'model/mobile_small_epoch_30.pth'  # Path to the trained model weights
