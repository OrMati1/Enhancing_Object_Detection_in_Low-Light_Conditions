...
# Setup logging to save output in a file and print to console
...
def find_latest_checkpoint(checkpoint_dir):
    ...
    pattern = re.compile(r"mobile_big_epoch_(\d+)\.pth")
    max_epoch = 0
...
def get_dataloader(dataset_name, transform, subset_size, skipped_images):
    if dataset_name == 'LoL':
        dataset = LoLDataset(
            base_path='C:/Users/Or/Desktop/University Files/Second Degree/Deep Learning/FinalProject/UHD-Low-light-image-enhancement/database/database_lol/our485',
            transform=transform,
        ...
        dataset = ExDarkDataset(
            bright_light_path='C:/Users/Or/Desktop/University Files/Second Degree/Deep Learning/Project/MIRNetv2_ImageEnhancement_with_my_changes/training_data/bright_light/lowlight_enhancement',
            low_light_path='C:/Users/Or/Desktop/University Files/Second Degree/Deep Learning/Project/MIRNetv2_ImageEnhancement_with_my_changes/training_data/low_light',
            transform=transform,
            subset_size=subset_size,
            skipped_images=skipped_images
        )
...
def main(num_epochs=50, subset_size=None, dataset_name='LoL'):
    ...
    model = MobileNetV3UNet().to(device)  # Ensure you're using the correct model class
    optimizer = optim.Adam(model.parameters(), lr=0.001)
    criterion = nn.MSELoss()

    checkpoint_dir = 'C:/Users/Or/Desktop/University Files/Second Degree/Deep Learning/FinalProject/UHD-Low-light-image-enhancement/model'
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for inputs, targets in tqdm(dataloader, desc=f"Epoch {epoch + 1}/{num_epochs}"):
            ...
            psnr_val, ssim_val = calculate_metrics(outputs_resized, targets)
        ...
        checkpoint_path = os.path.join(checkpoint_dir, f'mobile_big_epoch_{epoch + 1}.pth')
        torch.save({
            'epoch': epoch + 1,
...
if __name__ == '__main__':
    main(num_epochs=100, subset_size=None, dataset_name='ExDark')  # Adapt parameters
